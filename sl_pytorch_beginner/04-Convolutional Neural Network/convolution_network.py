...
class Cnn(nn.Module):
    def __init__(self, in_dim, n_class):
        ...
        self.conv = nn.Sequential(
            nn.Conv2d(in_dim, 6, 3, stride=1, padding=1),#(输入维数，输出维数，卷积核大小，步长，是否补领)
            nn.ReLU(True),
            nn.MaxPool2d(2, 2),
...
for epoch in range(num_epoches):
    ...
    for i, data in enumerate(train_loader, 1):
        ...
        conv_l1 = model.conv[0]
        print("conv_l1 weights:",conv_l1.weight,"; size: ",conv_l1.weight.size(),";bias: " , conv_l1.bias)
